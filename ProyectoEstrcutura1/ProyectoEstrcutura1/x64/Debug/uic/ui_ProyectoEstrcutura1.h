/********************************************************************************
** Form generated from reading UI file 'ProyectoEstrcutura1.ui'
**
...
#ifndef UI_PROYECTOESTRCUTURA1_H
#define UI_PROYECTOESTRCUTURA1_H
...
class Ui_ProyectoEstrcutura1Class
{
public:
    ...
    QPushButton *stack;
    QPushButton *queue;
    QPushButton *listaEnlazada;
    QToolBar *mainToolBar;
    QStatusBar *statusBar;

    void setupUi(QMainWindow *ProyectoEstrcutura1Class)
    {
        if (ProyectoEstrcutura1Class->objectName().isEmpty())
            ProyectoEstrcutura1Class->setObjectName("ProyectoEstrcutura1Class");
        ProyectoEstrcutura1Class->resize(803, 541);
        ProyectoEstrcutura1Class->setStyleSheet(QString::fromUtf8(""));
        centralWidget = new QWidget(ProyectoEstrcutura1Class);
...
""));
        ...
        guardarlistabutton->setFont(font);
        guardarlistabutton->setCursor(QCursor(Qt::PointingHandCursor));
        guardarlistabutton->setStyleSheet(QString::fromUtf8("color: rgb(0, 0, 0);\n"
...
""));
        ...
        editararchivobutton->setFont(font);
...
"background-color: rgb(0, 0, 255);"));
        ...
        frame_view->setAutoFillBackground(false);
...
""));
        ...
        scroll_view->setStyleSheet(QString::fromUtf8(""));
        ...
        label_archivo->setGeometry(QRect(440, 480, 331, 20));
        label_archivo->setStyleSheet(QString::fromUtf8("color: rgb(0, 0, 0);"));
        ...
        toolbarbutton->setStyleSheet(QString::fromUtf8("color: rgb(255, 0, 0);\n"
"background-color: rgb(255, 255, 255);"));
...
""));
        ...
        QFont font4;
        font4.setBold(true);
        buscar->setFont(font4);
        buscar->setCursor(QCursor(Qt::PointingHandCursor));
        buscar->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 0, 0);"));
...
"border-color: rgb(0, 0, 0);"));
        ...
        agregar->setFont(font4);
        agregar->setCursor(QCursor(Qt::PointingHandCursor));
        agregar->setLayoutDirection(Qt::LeftToRight);
        agregar->setStyleSheet(QString::fromUtf8("background-color: rgb(0, 0, 255);"));
        stack = new QPushButton(centralWidget);
        stack->setObjectName("stack");
        stack->setGeometry(QRect(20, 480, 75, 24));
        stack->setFont(font4);
        stack->setStyleSheet(QString::fromUtf8("background:rgb(255, 0, 0);\n"
"color:rgb(255,255,255)"));
        queue = new QPushButton(centralWidget);
        queue->setObjectName("queue");
        queue->setGeometry(QRect(110, 480, 75, 24));
        queue->setFont(font4);
        queue->setStyleSheet(QString::fromUtf8("background:rgb(0, 0, 255);\n"
"color:rgb(255,255,255)"));
        listaEnlazada = new QPushButton(centralWidget);
        listaEnlazada->setObjectName("listaEnlazada");
        listaEnlazada->setGeometry(QRect(200, 480, 75, 24));
        listaEnlazada->setFont(font4);
        listaEnlazada->setStyleSheet(QString::fromUtf8("background:rgb(255, 255, 255);\n"
"color:rgb(0,0,0)"));
        ProyectoEstrcutura1Class->setCentralWidget(centralWidget);
        mainToolBar = new QToolBar(ProyectoEstrcutura1Class);
        mainToolBar->setObjectName("mainToolBar");
        ProyectoEstrcutura1Class->addToolBar(Qt::TopToolBarArea, mainToolBar);
        statusBar = new QStatusBar(ProyectoEstrcutura1Class);
        statusBar->setObjectName("statusBar");
        ProyectoEstrcutura1Class->setStatusBar(statusBar);

        retranslateUi(ProyectoEstrcutura1Class);

        QMetaObject::connectSlotsByName(ProyectoEstrcutura1Class);
    } // setupUi

    void retranslateUi(QMainWindow *ProyectoEstrcutura1Class)
    {
        ProyectoEstrcutura1Class->setWindowTitle(QCoreApplication::translate("ProyectoEstrcutura1Class", "ProyectoEstrcutura1", nullptr));
        crearlistabutton->setText(QCoreApplication::translate("ProyectoEstrcutura1Class", "Crear Lista", nullptr));
        guardarlistabutton->setText(QCoreApplication::translate("ProyectoEstrcutura1Class", "Guardar Lista", nullptr));
        editararchivobutton->setText(QCoreApplication::translate("ProyectoEstrcutura1Class", "Abrir Archivo", nullptr));
        buttt_null->setText(QCoreApplication::translate("ProyectoEstrcutura1Class", "\342\227\217 NULLPTR", nullptr));
        butt_header->setText(QCoreApplication::translate("ProyectoEstrcutura1Class", "\342\227\217 Header", nullptr));
        groupBox->setTitle(QString());
        label_archivo->setText(QString());
        toolbarbutton->setText(QCoreApplication::translate("ProyectoEstrcutura1Class", "Toolbar - Options", nullptr));
        groupBox_menu->setTitle(QCoreApplication::translate("ProyectoEstrcutura1Class", "Menu", nullptr));
        label_buscar->setText(QCoreApplication::translate("ProyectoEstrcutura1Class", "Buscar", nullptr));
        buscar->setText(QCoreApplication::translate("ProyectoEstrcutura1Class", "Buscar", nullptr));
        label_eliminar->setText(QCoreApplication::translate("ProyectoEstrcutura1Class", "Eliminar", nullptr));
        eliminar->setText(QCoreApplication::translate("ProyectoEstrcutura1Class", "Eliminar", nullptr));
        label_insertar->setText(QCoreApplication::translate("ProyectoEstrcutura1Class", "Insertar", nullptr));
        agregar->setText(QCoreApplication::translate("ProyectoEstrcutura1Class", "Agregar", nullptr));
        stack->setText(QCoreApplication::translate("ProyectoEstrcutura1Class", "Stack", nullptr));
        queue->setText(QCoreApplication::translate("ProyectoEstrcutura1Class", "Queue", nullptr));
        listaEnlazada->setText(QCoreApplication::translate("ProyectoEstrcutura1Class", "Lista", nullptr));
    } // retranslateUi

};

namespace Ui {
    class ProyectoEstrcutura1Class: public Ui_ProyectoEstrcutura1Class {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_PROYECTOESTRCUTURA1_H
